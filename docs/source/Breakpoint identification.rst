...
Break points are identified with **Fisher-Jenks Natural Breaks algorithm**. The method was originally published in George Jenks’ (1977) Optimal Data Classification for Choropleth Maps. The method primarily derived from Walter Fisher’s work ‘On grouping for maximum homogeneity‘ (1958) has become a popular statistical method of breakpoint analysis since then.
