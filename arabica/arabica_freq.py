...
def arabica_freq(text: str,
    ...
    if time_freq == 'ungroup':
        ...
        bigrams_freq_adj = [x for x in bigrams_freq if x != []]
        bigrams_freq_adj_second = bigrams_freq_adj[0]
        bigrams_frequency_ungr = nltk.bigrams(bigrams_freq_adj_second)
        bigrams_ungr = nltk.FreqDist(bigrams_freq_adj_second)
        ...
        trigrams_freq_adj = [x for x in trigrams_freq if x != []]
        trigrams_freq_adj_second = trigrams_freq_adj[0]
        trigrams_frequency_ungr = nltk.bigrams(trigrams_freq_adj_second)
        trigrams_ungr = nltk.FreqDist(trigrams_freq_adj_second)
