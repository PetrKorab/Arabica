...
As an example, a word cloud in the top left corner of Fig. 1 displays the most frequent 
...
Review, Quarterly Journal of Economics, and Review of Economic Studies). A heatmap in the 
top right corner plots the most frequent terms with a specified frequency. The line plot 
(bottom left) displays the most frequent concepts in an alternative form, and sentiment 
analysis with breakpoint identification is presented as a line plot (bottom right).
...
![Caption for example figure.](heatmap.png)
