...
It reads dates in the **US-style** (MM/DD/YYYY) `date and datetime formats <https://docs.python.org/3.8/library/datetime.html>`_ (e.g., 2013–12–31, 2013/12/31, Feb-09-2009, 2013–12–31 11:46:17, 09/02/2009 09:26).
